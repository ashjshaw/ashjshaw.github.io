import{s as i,j as A,L as u,r as d,B as k,R as S,a as w,b as R,c as I}from"./vendor.7059da55.js";const E=function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function r(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(a){if(a.ep)return;a.ep=!0;const l=r(a);fetch(a.href,l)}};E();const x=i.div`
display: flex;
...
`;function G({gloss:t,setGloss:n}){return o(j,{children:[e("h1",{children:"Ashley Shaw"}),t?o(h,{children:[e("p",{children:"Welcome to my portfolio"})," "]}):e(h,{children:e("p",{children:"How do!"})})]})}var C="/assets/Me.d47b1027.png",M="/assets/Glosme.d41c258b.png",y="/assets/reviewarrow.aecc7865.svg";const Q=i.div`
display: flex;
width: 80vw;
...
`,se=i.div`
display: flex;
`;function le(){const[t,n]=d.exports.useState(""),[r,s]=d.exports.useState([{description:"Make to do List"}]);function a(c){if(c.preventDefault(),t==="")return null;n("");let m=[{description:t},...r];s(m)}function l(c,m){c.preventDefault();let p=[...r];p.splice(m,1),s(p)}return e(oe,{children:o(re,{children:[e("h1",{children:"To do List"}),e("input",{type:"text",value:t,onChange:c=>n(c.target.value)}),e("button",{onClick:a,children:"AddTask"}),e("ul",{children:r.map((c,m)=>o(se,{children:[e("li",{children:c.description}),e(ae,{onClick:p=>l(p,m),children:"X"})]},m))})]})})}function ce(){const[t,n]=d.exports.useState(!1);return o("div",{children:[e(b,{source:te}),e(v,{show:t,setShow:n}),o(B,{show:t,children:[e(ie,{}),e(le,{})]})]})}var de="/assets/contactimage.4d745422.png";const he=i.main`
  display: flex;
  flex-direction: column;
  height: 85vh;
  width: 35vh;
